...
LOG_FILE_PATH = "./log/log_.log"
EXP_CSV_PATH="./exp_list_/Users/ishikawakanji/desktop/PROGRAM/tensyoku.csv"
...
def main():
    ...
    df.to_csv(EXP_CSV_PATH.replace("Users/ishikawakanji/desktop/PROGRAM/tensyoku.csv",search_keyword).replace("",now), encoding="utf-8-sig")
